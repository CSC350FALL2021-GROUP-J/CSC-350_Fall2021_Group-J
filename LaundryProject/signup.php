...
$sql="SELECT * FROM Laundry.user where UserName='".$userid."' AND UserPass='".$passwd."'";//create query string
...
{
	$sql = "INSERT INTO Laundry.user (UserName, UserPass) VALUES ('".$userid."','".passwd."');"; //create query string
	$result = mysqli_query($connect,$sql);
	$connect->close();
